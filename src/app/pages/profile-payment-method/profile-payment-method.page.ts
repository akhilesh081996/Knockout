...
@Component({
  ...
  templateUrl: './profile-payment-method.page.html',
  styleUrls: ['./profile-payment-method.page.scss'],
})

export class ProfilePaymentMethodPage implements OnInit {
...
async  ngOnInit() {
   ...
   if(!this.user.card_number) return
  
   this.validationsform.patchValue({
    card_number: this.user.card_number,
    expiration_date:this.user.card_expiration_date,
